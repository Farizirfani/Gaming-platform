  ...
  return (
    <div className='canvas-portofolio'>
      <div className="main-portofolio  h-auto">
        ...
        <div className='md:px-[110px] px-7 py-4'>
          <div className='xl:flex justify-center xl:justify-between content-center items-center md:py-14'>
            <div className=' flex justify-center xl:max-w-[670px]'>
          ...
          <div className='lg:flex  justify-center lg:justify-between items-center md:py-14 py-7'>
            <div className='text-white'>
              <h1 className='lg:text-2xl text-lg font-bold py-4'>Lorem ipsum dolor, sit amet <br /> consectetur adipisicing elit. Nobis, earum!</h1>
              <p className='lg:w-1/2 md:py-8 py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae magnam eaque perspiciatis quisquam alias praesentium voluptatibus ipsum vel quod. Voluptate! Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque, rerum.</p>
              <p className='py-3 font-light'>Lorem ipsum dolor sit amet consectetur, <br /> adipisicing elit. Ex quos possimus aliquam reprehenderit!</p>
              <button className='bg-[#34085f] hover:bg-[#21093a] md:my-3 my-3 text-white py-3 px-6 rounded-lg'>Read more</button>
            </div>
          ...
          <div className='lg:flex justify-center lg:justify-between items-center md:py-14 py-7'>
            ...
            <div className='text-white  lg:w-1/2'>
              <h1 className='lg:text-2xl text-lg font-bold py-4'>Lorem ipsum dolor, sit amet <br /> consectetur adipisicing elit. Nobis, earum!</h1>
              <p className=' md:py-8'>Lorem  py-4ipsum dolor sit amet consectetur adipisicing elit. Beatae magnam eaque perspiciatis quisquam alias praesentium voluptatibus ipsum vel quod. Voluptate! Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque, rerum.</p>
              <p className='py-3 font-light'>Lorem ipsum dolor sit amet consectetur, <br /> adipisicing elit. Ex quos possimus aliquam reprehenderit!</p>
              <button className='bg-[#34085f] hover:bg-[#21093a] md:my-3 my-3 text-white py-3 px-6 rounded-lg'>Read more</button>
            </div>
          </div>
